...
class TestStockAnalyticsReport(FrappeTestCase):
	...
	def test_value_mode_T_SA_001(self):
		today = getdate()
	...
	def test_stock_reconciliation_entry_T_SA_002(self):
	...
	def test_weekly_range_T_SA_003(self):
		today = getdate()
	...
	def test_quarterly_range_T_SA_004(self):
		today = getdate()
		posting_date = today.replace(day=15)
